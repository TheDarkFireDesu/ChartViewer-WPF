...
namespace ChartViewer
{
    public partial class MainWindow : Window
    {
        ...
        public int InterpolationValue = 200;
        public int minX = -30;
        public int maxX = 30;
        ...
        private void Linear_Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            FinalFunc_Label.Text = Defs.FinalFormulaLabelView_NonLaTex(a, b, c, d, NOF);
        ...
        {
            x = Defs.CalculateX(minX, maxX, Step, NOF);
            ...
            {
                data_y = Defs.CalculateFunc(a, b, c, d, NOF, x.Length);
                y = data_y.ToArray();
